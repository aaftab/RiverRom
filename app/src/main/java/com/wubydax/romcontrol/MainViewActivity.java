...
public class MainViewActivity extends AppCompatActivity
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        * See more detailed instructions on the thread or in annotations to the previous method*/
        ...
        switch (position) {
            case 0:
                getFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.container, new about_prefsFragment()).commitAllowingStateLoss();
                break;
            case 1:
                getFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.container, new statusbar_prefsFragment()).commitAllowingStateLoss();
                break;
            case 2:
                getFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.container, new notification_panel_prefsFragment()).commitAllowingStateLoss();
                break;
            case 3:
                getFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.container, new lockscreen_prefsFragment()).commitAllowingStateLoss();
                break;
            case 4:
                getFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.container, new buttons_and_display_prefsFragment()).commitAllowingStateLoss();
                break;
            case 5:
                getFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.container, new extended_power_menu_prefsFragment()).commitAllowingStateLoss();
                break;
            case 6:
                getFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.container, new phone_prefsFragment()).commitAllowingStateLoss();
                break;
            case 7:
                getFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.container, new sound_prefsFragment()).commitAllowingStateLoss();
                break;
            case 8:
                getFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.container, new general_prefsFragment()).commitAllowingStateLoss();
                break;
            case 9:
                getFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.container, new app_links_prefsFragment()).commitAllowingStateLoss();
                break;
            case 10:
